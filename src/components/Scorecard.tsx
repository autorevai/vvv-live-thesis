  ...
  return (
    <Card>
      <SectionHead
        ...
        sub="Each row carries the rule that decides its signal, written before the data moved. Rows with no live source say so rather than showing a stale figure as current."
      />
      <TableScroll>
