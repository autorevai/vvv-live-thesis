      ...
      <main className="flex min-h-screen items-center justify-center px-6 text-center">
        <div>
          ...
          <p className="mx-auto mt-2 max-w-md text-[13px] leading-relaxed text-[var(--text-faint)]">
            One of the upstream sources is not responding. Nothing is estimated in its place, so the
            page waits rather than showing a number it cannot stand behind.
          </p>
          <button
    ...
    <footer className="border-t">
      <div className="mx-auto max-w-[1180px] px-4 py-8 sm:px-6 sm:py-10">
        <p className="max-w-3xl text-[12px] leading-relaxed text-[var(--text-faint)]">
          This page tracks a personal investment thesis in public. It is not investment advice, not
          a solicitation, and not affiliated with Venice AI. Every figure carries its source and the
          time it was read. Where a live source does not exist, the page says so rather than filling
